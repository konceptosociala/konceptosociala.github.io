...
var $author$project$Event$PostLoaded = F2(
	function (a, b) {
		return {$: 'PostLoaded', a: a, b: b};
	});
var $author$project$Event$PostsIndexLoaded = function (a) {
	return {$: 'PostsIndexLoaded', a: a};
};
...
var $author$project$Utils$Post$PostData = F3(
	function (title, date, link) {
		return {date: date, link: link, title: title};
	});
...
var $author$project$Utils$Utils$copyleft = F2(
	function (name, year) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($author$project$Utils$Utils$copyleft, 'Koncepto Sociala', year)
					]))
			]));
};
								...
								[
									...
									_List_fromArray(
										[
											...
											$elm$html$Html$Attributes$class('btn btn-outline-light font-monospace text-light'),
...
var $author$project$Model$init = F3(
	function (flags, url, key) {
		...
		var model = {blogPosts: $elm$core$Maybe$Nothing, currentPage: $elm$core$Maybe$Nothing, currentTitle: $elm$core$Maybe$Nothing, key: key, route: route, year: flags.year};
		var _v0 = model.route;
		switch (_v0.$) {
			case 'Home':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							currentPage: $elm$core$Maybe$Just(
								A3(
									$author$project$Utils$Utils$pageLayout,
									model.route,
									'Koncepto Sociala',
									$author$project$Page$Home$view(model.year))),
							currentTitle: $elm$core$Maybe$Just('Koncepto Sociala')
						}),
			...
			case 'Projects':
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							currentPage: $elm$core$Maybe$Just(
								A3($author$project$Utils$Utils$pageLayout, model.route, 'Projects', $author$project$Page$Projects$view)),
							currentTitle: $elm$core$Maybe$Just('Projects')
						}),
					$elm$core$Platform$Cmd$none);
			case 'Blog':
				return _Utils_Tuple2(
					...
					$elm$http$Http$get(
						{
							expect: A2($elm$http$Http$expectJson, $author$project$Event$PostsIndexLoaded, $author$project$Utils$Post$postListDecoder),
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							currentTitle: $elm$core$Maybe$Just('404 | Not Found')
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var id = _v0.a;
...
var $author$project$Event$DomReady = {$: 'DomReady'};
...
var $author$project$Utils$Post$Post = F3(
	function (name, date, content) {
		return {content: content, date: date, name: name};
	});
...
var $author$project$Utils$Utils$deadendToString = function (e) {
	return $elm$core$String$fromInt(e.row) + (':' + ($elm$core$String$fromInt(e.col) + (': ' + $author$project$Utils$Utils$problemToString(e.problem))));
};
...
var $author$project$Utils$Date$compare = F2(
	function (d1, d2) {
		var _v0 = A2($elm$core$Basics$compare, d1.year, d2.year);
		if (_v0.$ === 'EQ') {
			var _v1 = A2($elm$core$Basics$compare, d1.month, d2.month);
			if (_v1.$ === 'EQ') {
				return A2($elm$core$Basics$compare, d1.day, d2.day);
			} else {
				var other = _v1;
				return other;
			}
...
var $author$project$Utils$Post$comparePostDataDesc = F2(
	function (p1, p2) {
		return A2($author$project$Utils$Date$compare, p2.date, p1.date);
	});
...
var $author$project$Utils$Date$toString = function (date) {
	return $author$project$Utils$Date$leadingZeroToString(date.year) + ('-' + ($author$project$Utils$Date$leadingZeroToString(date.month) + ('-' + $author$project$Utils$Date$leadingZeroToString(date.day))));
};
var $author$project$Page$Blog$viewPost = function (post) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text(
				$author$project$Utils$Date$toString(post.date)),
				$elm$html$Html$text(' - '),
				A2(
				$elm$html$Html$a,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$href('/post/' + post.link),
						$elm$html$Html$Attributes$class('blog-post-link')
					]),
				_List_fromArray(
					[
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									...
									currentTitle: $elm$core$Maybe$Just(p.name)
								}),
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									...
									currentTitle: $elm$core$Maybe$Just('Post parsing error')
								}),
							$elm$core$Platform$Cmd$none);
					}
				} else {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								currentTitle: $elm$core$Maybe$Just('Blog')
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								currentTitle: $elm$core$Maybe$Just('Posts index not found or is invalid')
							}),
						$elm$core$Platform$Cmd$none);
				}
			default:
				return _Utils_Tuple2(
					model,
					$author$project$Update$sendMessage(_Utils_Tuple0));
		}
	});
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		init: $author$project$Model$init,
		onUrlChange: $author$project$Event$UrlChange,
		onUrlRequest: $author$project$Event$LinkClicked,
		subscriptions: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		update: $author$project$Update$update,
		view: function (m) {
			return {
				body: function () {
					var _v0 = m.currentPage;
					if (_v0.$ === 'Just') {
						var pageView = _v0.a;
						return _List_fromArray(
							[pageView]);
